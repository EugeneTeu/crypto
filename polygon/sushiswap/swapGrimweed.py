...
from src.clients import getTokenClient
...
grimweedContract = GRIMWEED_TO_USDC[0]
grimweedWeb3Client = getTokenClient(grimweedContract)
balance = grimweedWeb3Client.getBalance()
swapTxnV2(balance, GRIMWEED_TO_USDC)
